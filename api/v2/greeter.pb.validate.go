...
// Validate checks the field values on SayHelloReply with the rules defined in
// the proto definition for this message. If any rules are violated, an error
// is returned.
func (m *SayHelloReply) Validate() error {
	if m == nil {
		return nil
	}
...
// SayHelloReplyValidationError is the validation error returned by
// SayHelloReply.Validate if the designated constraints aren't met.
type SayHelloReplyValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e SayHelloReplyValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e SayHelloReplyValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e SayHelloReplyValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e SayHelloReplyValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e SayHelloReplyValidationError) ErrorName() string { return "SayHelloReplyValidationError" }

// Error satisfies the builtin error interface
func (e SayHelloReplyValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
...
var _ error = SayHelloReplyValidationError{}
